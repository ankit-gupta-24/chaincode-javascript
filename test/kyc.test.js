...
describe('Asset Transfer Basic Tests', () => {
    ...
    describe('Test InitLedger', () => {
        it('should return error on InitLedger', async () => {
            ...
            let kyc = new KYC();
            try {
                await kyc.InitLedger(transactionContext);
    ...
    describe('Test CreateAsset', () => {
        it('should return error on CreateAsset', async () => {
            ...
            let kyc = new KYC();
            try {
                await kyc.CreateAsset(transactionContext, asset.ID, asset.Color, asset.Size, asset.Owner, asset.AppraisedValue);
    ...
    describe('Test ReadAsset', () => {
        it('should return error on ReadAsset', async () => {
            ...
            try {
                await kyc.ReadAsset(transactionContext, 'asset2');
    ...
    describe('Test UpdateAsset', () => {
        it('should return error on UpdateAsset', async () => {
            ...
            try {
                await kyc.UpdateAsset(transactionContext, 'asset2', 'orange', 10, 'Me', 500);
        ...
        it('should return success on UpdateAsset', async () => {
            ...
            await kyc.UpdateAsset(transactionContext, 'asset1', 'orange', 10, 'Me', 500);
            let ret = JSON.parse(await chaincodeStub.getState(asset.ID));
            let expected = {
                ID: 'asset1',
                Color: 'orange',
    ...
    describe('Test DeleteAsset', () => {
        it('should return error on DeleteAsset', async () => {
            ...
            try {
                await kyc.DeleteAsset(transactionContext, 'asset2');
        ...
        it('should return success on DeleteAsset', async () => {
            ...
            await kyc.DeleteAsset(transactionContext, asset.ID);
    ...
    describe('Test TransferAsset', () => {
        it('should return error on TransferAsset', async () => {
            ...
            try {
                await kyc.TransferAsset(transactionContext, 'asset2', 'Me');
                assert.fail('DeleteAsset should have failed');
            } catch (err) {
                expect(err.message).to.equal('The asset asset2 does not exist');
            }
        ...
        it('should return success on TransferAsset', async () => {
            ...
            await kyc.TransferAsset(transactionContext, asset.ID, 'Me');
            let ret = JSON.parse((await chaincodeStub.getState(asset.ID)).toString());
    ...
    describe('Test GetAllAssets', () => {
        it('should return success on GetAllAssets', async () => {
            ...
            await kyc.CreateAsset(transactionContext, 'asset1', 'blue', 5, 'Robert', 100);
            await kyc.CreateAsset(transactionContext, 'asset2', 'orange', 10, 'Paul', 200);
            await kyc.CreateAsset(transactionContext, 'asset3', 'red', 15, 'Troy', 300);
            await kyc.CreateAsset(transactionContext, 'asset4', 'pink', 20, 'Van', 400);

            let ret = await kyc.GetAllAssets(transactionContext);
            ret = JSON.parse(ret);
